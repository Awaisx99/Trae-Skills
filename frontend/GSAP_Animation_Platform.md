...
<div class="scroll-container" style="position: relative; height: 400vh; padding: 150vh 0;">
...
2. Use **Outer Section** → Add custom class `scroll-container` → Set height to 400vh → Add padding 150vh top/bottom
...
- Change `height: 400vh` on `.scroll-container` to adjust scroll distance

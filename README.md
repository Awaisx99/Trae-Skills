...
## 📖 Guide for AI Assistants (Read This First!)

If you're an AI assistant assigned to help with projects, welcome! Here's how to use this library:

### 🔍 What You Need to Know

1. **This is your training manual**: All expertise is in this directory - read relevant skills first before performing tasks!
2. **Skills are organized by category**: Frontend, Backend, WordPress, DevOps, Security, etc. (see directory list below)
3. **WordPress-specific skills**: These are custom-added and cover Core WordPress, Elementor, WooCommerce, and ACF (Advanced Custom Fields)
4. **Frontend additions**: Also custom-added are `GSAP_Animation_Platform` (for pro animations) and `Figma_to_Pixel_Perfect_Code` (to convert designs exactly)
5. **Use `metadata.json`**: This file lists all skills with IDs, names, categories, and tags for easy lookup!

### 🚀 When Starting a Task

1. **Identify the relevant categories**: For example, if building a WordPress site with Elementor and animations, check:
   - `wordpress/`
   - `frontend/`
2. **Read the relevant skill files**: Before coding, open and read the specific skill .md files!
3. **Follow the procedures in skills**: Each skill has step-by-step guidance - use that process!
4. **Preserve consistency**: Always follow the patterns, code styles, and best practices from this library!

### 📂 Key Skill Files for Our Projects

- **WordPress Core**: `wordpress/Core_WordPress_Development.md`
- **Elementor**: `wordpress/Elementor_Page_Builder.md`
- **WooCommerce**: `wordpress/WooCommerce_ECommerce.md`
- **ACF**: `wordpress/Advanced_Custom_Fields_ACF.md`
- **GSAP Animations**: `frontend/GSAP_Animation_Platform.md`
- **Figma to Code**: `frontend/Figma_to_Pixel_Perfect_Code.md`
